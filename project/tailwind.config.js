  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-cta-hover': 'linear-gradient(135deg, #059669 0%, #047857 50%, #065f46 100%)',
        'gradient-brand': 'linear-gradient(135deg, #dc2626 0%, #b91c1c 100%)',
        'gradient-hero': 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #334155 100%)',
        'gradient-text': 'linear-gradient(135deg, #dc2626 0%, #f87171 50%, #dc2626 100%)',
        'gradient-accent': 'linear-gradient(135deg, #10b981 0%, #34d399 50%, #10b981 100%)',
      },
      boxShadow: {
        'glow': '0 0 20px rgba(16, 185, 129, 0.3)',
        'glow-lg': '0 0 40px rgba(16, 185, 129, 0.4)',
        'glow-brand': '0 0 20px rgba(220, 38, 38, 0.3)',
