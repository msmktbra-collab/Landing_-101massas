  ...
  return (
    <section className="bg-white py-8 md:py-12">
      <div className="container mx-auto px-4">
        <h2 className="text-xl md:text-2xl font-bold text-center mb-6 leading-tight px-2 text-neutral-900">
          O que torna esse e-book indispensável na sua cozinha?
        </h2>
        
        <div className="max-w-4xl mx-auto px-2">
          <div className="text-center mb-6">
            <div className="inline-block rounded-2xl overflow-hidden shadow-xl border-4 border-neutral-100 transition-all duration-500 hover:shadow-2xl relative">
          ...
          <div className="text-neutral-700 text-center mb-6 max-w-3xl mx-auto px-2">
            <div className="bg-gold-500/10 p-4 rounded-xl mb-4 border border-gold-500/30 shadow-sm">
              <p className="font-bold text-base md:text-lg text-neutral-800 mb-2">
                Você não precisa gastar uma fortuna para comer incrivelmente bem.
              </p>
            </div>

            <p className="mb-4 text-sm md:text-base leading-relaxed font-medium px-2 text-neutral-700">
          ...
          <div className="grid gap-2 max-w-2xl mx-auto mb-8 px-2">
            <div className="flex items-center space-x-3 p-3 bg-white rounded-lg shadow-sm border border-neutral-100">
              <span className="text-accent-500 flex-shrink-0 text-lg">✓</span>
              <span className="text-neutral-700 text-sm md:text-base font-semibold">Tabela de preços em cada receita para você controlar seu orçamento</span>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-white rounded-lg shadow-sm border border-neutral-100">
              <span className="text-accent-500 flex-shrink-0 text-lg">✓</span>
              <span className="text-neutral-700 text-sm md:text-base font-semibold">Tempo médio de preparo: 10 a 25 minutos — perfeito para a rotina</span>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-white rounded-lg shadow-sm border border-neutral-100">
              <span className="text-accent-500 flex-shrink-0 text-lg">✓</span>
              <span className="text-neutral-700 text-sm md:text-base font-semibold">Ingredientes acessíveis que você encontra em qualquer mercado</span>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-white rounded-lg shadow-sm border border-neutral-100">
              <span className="text-accent-500 flex-shrink-0 text-lg">✓</span>
              <span className="text-neutral-700 text-sm md:text-base font-semibold">Adaptado para o Brasil: substituições inteligentes de ingredientes caros</span>
            </div>
          </div>
