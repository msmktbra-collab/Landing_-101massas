          ...
          <div className="card-modern p-5 sm:p-6 md:p-8 relative overflow-hidden">
            ...
            <div className="text-center">
              ...
              <a
                ...
                className="initiate-checkout block w-full bg-gradient-to-r from-accent-500 to-accent-600 hover:from-accent-600 hover:to-accent-700 text-white font-bold py-3 sm:py-4 px-5 sm:px-6 rounded-full text-sm sm:text-base shadow-lg hover:shadow-glow-lg transition-all duration-300 text-center whitespace-nowrap"
              >
            ...
            <div className="relative bg-white rounded-2xl shadow-elevated p-5 sm:p-6 md:p-8 border-2 border-brand-500 overflow-hidden">
              ...
              <div className="text-center">
                ...
                <a
                  ...
                  className="initiate-checkout btn-gradient block w-full text-base md:text-lg animate-pulse-glow whitespace-nowrap"
                >
