        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border border-neutral-200 relative overflow-hidden">
            ...
            <div className="text-center">
              ...
              <a
                href="#"
                className="block w-full bg-success-600 hover:bg-success-700 text-white font-bold py-3 px-6 rounded-full text-sm shadow-md hover:shadow-lg transition-all duration-200 text-center"
              >
                QUERO MEU E-BOOK
              </a>
            </div>
