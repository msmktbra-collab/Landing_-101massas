...
const RecipesShowcase: React.FC = () => {
  ...
  return (
    <section className="bg-primary-600 py-8 md:py-12">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-white/80 text-sm md:text-base font-normal mb-2 px-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto mb-6 px-2">
          {recipes.map((recipe, index) => (
            ...
            >
              ...
              />
              <div className="p-4">
                <h3 className="font-bold text-lg mb-2 leading-tight text-primary-600 text-center">{recipe.title}</h3>
                <p className="text-neutral-600 text-sm leading-relaxed mb-3 text-center">{recipe.description}</p>
                ...
                <div className="flex justify-center space-x-4">
                  <div className="flex items-center space-x-1 bg-primary-100 px-3 py-1 rounded-full">
                    ...
                    <span className="text-primary-600 text-xs font-semibold">{recipe.time}</span>
                  </div>
                  <div className="flex items-center space-x-1 bg-success-100 px-3 py-1 rounded-full">
                    ...
                    <span className="text-success-600 text-xs font-semibold">{recipe.ingredients}</span>
                  </div>
                </div>
              </div>
            </div>
